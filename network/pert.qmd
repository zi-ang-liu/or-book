...
以上の方法では、作業の所要時間が確定していることを前提としている。しかし、実際には、所要時間の推定は難しい場合が多い。そこで、作業の所要時間を確率変数として扱い、3 点見積もり（Three-Point Estimation）という方法でその確率分布を推定する。

3 点見積もりでは、次の 3 つの所要時間を見積もる。
