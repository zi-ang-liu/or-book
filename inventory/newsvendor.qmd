...
:::{#exm-newsvendor-pdfcdf}
需要 $D$ が一様分布 $U(100,300)$ に従うとき、確率密度関数 $f_D(d)$ と累積分布関数 $F_D(d)$ は以下のように表される。
...
需要 $D \leq 200$ である確率は、累積分布関数 $F_D(200)$ で与えられる。

$$
P(D \leq 200) = F_D(200) = \int_{100}^{200} f_D(d) dd = 0.5
$$
:::
